...
class BalloonGame {
  ...
  render(ctx, width, height, localFingertip, peerFingertip) {
    ...
    this.balloons.forEach((b) => {
      ...
      // PERF: shadowBlur here used to re-run on EVERY balloon EVERY frame
      // (up to 12 at once) — replaced with a cached glow sprite (drawGlow,
      // see utils.js) which is a plain image blit instead of a live blur.
      drawGlow(ctx, bx, by, b.radius, mainColor, 1.5);

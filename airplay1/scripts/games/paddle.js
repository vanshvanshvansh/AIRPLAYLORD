...
class PaddleGame {
  constructor(overlayManager) {
    ...
    this.paddleA = { x: 0.5, width: 0.2, y: 0.92 }; // Bottom paddle (Player 1 Pink)
    this.paddleB = { x: 0.5, width: 0.2, y: 0.08 }; // Top paddle (Player 2 Cyan)
  ...
  updateBotPaddle() {
    const diff = window.getBotDifficulty ? window.getBotDifficulty() : { paddleMaxSpeed: 0.018 };
